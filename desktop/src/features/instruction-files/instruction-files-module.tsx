...
import type { AgentInstructionTargetInfo } from "@/shared/types/domain";
      ...
      <section className="flex h-full flex-col overflow-hidden">
        ...
        >
          ...
          {upperCollapsed && !upperFull && showLower && (
            ...
            >
              <span className="text-xs text-text-muted">Reference Syntax â€” collapsed</span>
          ...
          {lowerCollapsed && !lowerFull && showUpper && (
            ...
            >
              <span className="text-xs text-text-muted">Custom Generator â€” collapsed</span>
