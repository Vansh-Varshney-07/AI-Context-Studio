 ...
 * NO AI integration â€” this is purely the architectural shell per spec.
 */
    ...
    <section className="flex h-full flex-col overflow-hidden p-4">
      <header className="mb-2 space-y-1">
        ...
        <p className="text-xs leading-relaxed text-text-muted">
          ...
          generator stitches a starter instruction file locally â€” no AI yet.
        </p>
      </header>
...
/**
 * Concrete input switch. Kept simple â€” Phase 8 will polish interactions.
 */
