...
import { Download, Monitor, FileText, Shield, Hash, ExternalLink, ArrowRight, Code } from "lucide-react";
import { AppleIcon, LinuxIcon } from "@/components/icons/platform-icons";
import Link from "next/link";

export const metadata: Metadata = generateMetadata({
  title: "Download",
  description: "Download AI Context Studio for Windows, macOS, and Linux. Native desktop app built with Tauri — fast, secure, and lightweight. No Electron bloat.",
});
            ...
            <div className="mt-12 animate-slide-up" style={{ animationDelay: "0.6s" }}>
              ...
              <div className="max-w-3xl mx-auto space-y-3">
                {releaseNotes.slice(0, 3).map((release, index) => (
                  <div key={release.version} className="p-4 bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-lg animate-slide-up" style={{ animationDelay: `${0.6 + index * 0.1}s` }}>
