 ...
 * Mirror the CSS token values in globals.css (kept in sync; do NOT drift).
 */
export const EASE = {
...
/**
 * Slide-down variant. Use for panels entering from top.
 */
...
/**
 * Scale-in variant. Use for modals, popovers, tooltips.
 */
...
/**
 * Standard card hover interaction.
 * Apply to motion-enabled surface cards.
...
/**
 * Page/panel transition between modules.
 ...
 * Use via `useReducedMotion` hook to conditionally swap.
 */
