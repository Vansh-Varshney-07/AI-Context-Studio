...
import type { ModuleParams } from "@/types/navigation";
          ...
          <CardContent className="space-y-4 pt-6">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-xs text-text-secondary">
                ...
                <li>• No data sent to external servers without explicit action</li>
                <li>• API keys never leave your device</li>
                <li>• Encrypted storage with AES-GCM</li>
                <li>• No user accounts, no tracking, no cookies</li>
              </ul>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-xs text-text-secondary">MIT License — Free for personal and commercial use</p>
        </CardContent>
      </Card>
