          ...
          <div className="container-app">
            <div className="animate-slide-up mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-[var(--color-text-secondary)]">
                ...
                <a href="https://github.com/ai-context-studio/discussions" target="_blank" rel="noopener noreferrer" className="text-[var(--color-accent)] hover:underline">
                  Ask the community
                </a>
                {' '}or{' '}
...
{category.questions.map((faq, qIndex) => (
            ...
            <div className="animate-slide-up mt-12 text-center" style={{ animationDelay: '0.3s' }}>
              <Callout type="tip" title="Still have questions?">
                <p className="mb-4">
                  Search the full documentation, browse GitHub Discussions, or join our Discord community.
                </p>
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                  ...
                  <a
                    href="https://github.com/ai-context-studio/discussions"
                    target="_blank"
