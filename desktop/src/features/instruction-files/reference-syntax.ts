import type { ReferenceSection } from "@/shared/types/domain";
...
export const INSTRUCTION_SYNTAX: Record<string, ReferenceSection[]> = {
  claude: [
    ...
    },
    {
      ...
      body: "Areas under active refactoring:\n- Legacy components in `src/components/legacy` â€” migrate to new patterns\n- API client in `src/services/api` â€” replace with TanStack Query\n- State management â€” consolidate to Zustand stores",
    },
    {
      id: "do-not",
      heading: "Do Not Touch",
      body: "Files and patterns the AI should avoid:\n- `src/app/api/auth/*` â€” Authentication routes managed separately\n- `src/lib/auth/*` â€” Auth internals, do not modify\n- `src/middleware.ts` â€” Edge middleware, changes require review\n- Generated files in `src/generated/` â€” Do not edit manually",
    },
  ],
  cursor: [
    {
      id: "context",
      heading: "Context",
      body: "Describe the project goal, target users, and primary workflows. Keep it concise â€” Cursor reads this on every interaction.",
    },
    {
      id: "tech",
      heading: "Technology",
  ...
  gemini: [
    {
      ...
      body: "AI Context Studio â€” a premium hub for AI instruction engineering. Users create and export instruction files, prompts, personas, skills, workflows, and MCP configs for multiple AI coding assistants.",
    },
    {
      id: "technologies",
  ...
  codex: [
    {
      id: "summary",
      heading: "Summary",
      body: "AI Context Studio â€” premium web app for AI instruction engineering. Create, manage, and export instruction files, prompt templates, personas, skills, workflows, memories, and MCP configs for multiple AI coding assistants.",
    },
    {
      id: "commands",
      heading: "Commands",
      body: "- `npm run dev` â€” Start dev server\n- `npm run build` â€” Production build\n- `npm run typecheck` â€” TypeScript check\n- `npm run lint` â€” ESLint\n- `npm run format` â€” Prettier\n- `npm run test` â€” Vitest\n- `npm run test:e2e` â€” Playwright",
    },
    {
      id: "structure",
      heading: "Structure",
      body: "- `src/app` â€” Next.js App Router\n- `src/components` â€” Shared UI primitives\n- `src/features` â€” Feature modules (dashboard, instruction-files, prompt-library, etc.)\n- `src/lib` â€” Store, query client, utils\n- `src/services` â€” Providers, storage, crypto\n- `src/types` â€” Shared types\n- `src/constants` â€” Manifests, registries",
    },
    {
      id: "agents",
  ...
  opencode: [
    {
      id: "context",
      heading: "Context",
      body: "AI Context Studio â€” a premium web application for AI instruction engineering. Users create, customize, manage, and export AI assets for multiple AI coding assistants.",
    },
    {
      id: "stack",
      heading: "Stack",
    ...
    },
    {
      id: "tools",
      heading: "Tools",
      body: "- `src/lib/query-client.ts` â€” TanStack Query client\n- `src/lib/*-store.ts` â€” Zustand stores\n- `src/services/storage` â€” IndexedDB (Dexie)\n- `src/services/crypto` â€” AES-GCM encryption\n- `src/services/providers` â€” AI provider adapters",
    },
    {
      id: "rules",
      heading: "Rules",
      body: "- No `any` â€” use `unknown` + type guards\n- Validate all inputs with Zod\n- Encrypt secrets with AES-GCM\n- Use `cn()` for class merging\n- Framer Motion presets for animations",
    },
  ],
  continue: [
    {
  ...
  roo: [
    {
      id: "modes",
      heading: "Modes",
      body: "Named modes with responsibilities:\n- `architect` â€” High-level design, architecture decisions\n- `coder` â€” Implementation, feature development\n- `debugger` â€” Root cause analysis, fixes\n- `reviewer` â€” Code review, quality gates",
    },
    {
      id: "boundaries",
      heading: "Boundaries",
    ...
    },
    {
      id: "tools",
      heading: "Tools",
      body: "Permitted tool use per mode with approval gates:\n- `read` â€” Always allowed\n- `write` â€” `coder` + `debugger` (approval for new files)\n- `run` â€” `debugger` only (approval for commands)\n- `browser` â€” `architect` + `reviewer` (research)",
    },
    {
      id: "style",
      heading: "Style",
  ...
  general: [
    ...
    },
    {
      id: "commands",
      heading: "Commands",
      body: "- `npm run dev` â€” Development server\n- `npm run build` â€” Production build\n- `npm run typecheck` â€” TypeScript validation\n- `npm run lint` â€” ESLint\n- `npm run format` â€” Prettier\n- `npm run test` â€” Unit tests\n- `npm run test:e2e` â€” Playwright E2E",
    },
    {
      id: "structure",
      heading: "Structure",
      body: "- `src/app` â€” Next.js App Router pages/layouts\n- `src/components` â€” Shared UI (ui/, layout/, common/, motion/)\n- `src/features` â€” Feature modules (each self-contained)\n- `src/lib` â€” Stores, query client, utilities\n- `src/services` â€” External services (providers, storage, crypto)\n- `src/types` â€” Shared types (barrel exports)\n- `src/constants` â€” Registries, manifests",
    },
    {
      id: "global",
