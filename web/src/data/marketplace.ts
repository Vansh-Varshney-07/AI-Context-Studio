...
export const assets: Asset[] = [
  {
    ...
    description: "AI-powered code review assistant that analyzes PRs for bugs, security issues, and style violations. Provides inline comments and suggestions.",
    author: "janedoe",
...
\`\`\``,
    dependencies: [],
    versions: [
      { version: "2.1.0", date: "2024-01-15", changelog: "Added GitLab support, improved TypeScript analysis" },
  ...
  },
  {
    ...
    description: "A battle-tested senior engineer persona with 15+ years experience. Provides architectural guidance, mentorship, and pragmatic solutions.",
    author: "alexchen",
...
- Invest in developer experience`,
  ...
  },
  {
    ...
    description: "Production-ready React component templates with TypeScript, testing, Storybook, and accessibility built-in.",
    author: "uidev",
...
- WCAG AA compliance`,
  ...
  },
  {
    ...
    description: "Curated prompts for designing REST, GraphQL, and gRPC APIs. Covers versioning, error handling, pagination, and security.",
    author: "apidesigner",
...
- Rate limiting & pagination`,
    dependencies: [],
    versions: [
      { version: "1.0.0", date: "2024-01-05", changelog: "Initial release" },
    ],
  },
  {
    id: "clean-architecture-instructions",
    name: "Clean Architecture Instructions",
    description: "AGENTS.md instruction files for implementing Clean Architecture in any language. Includes layer definitions, dependency rules, and testing strategies.",
    author: "architect",
...
- Frameworks & Drivers`,
  ...
  },
  {
    ...
    description: "Multi-stage CI/CD workflow with linting, testing, security scanning, and deployment. Supports GitHub Actions, GitLab CI, and Azure Pipelines.",
    author: "devopspro",
...
7. Deploy to Production`,
  ...
  },
  {
    ...
    description: "Model Context Protocol server for PostgreSQL databases. Provides read-only query access, schema inspection, and query optimization hints.",
    author: "dbadmin",
...
- Connection pooling`,
  ...
  },
  {
    ...
    description: "Complete starter kits for React, Vue, Svelte, and Solid. Includes routing, state management, styling, and deployment configs.",
    author: "fullstackdev",
...
- SolidJS + TypeScript`,
    dependencies: [],
    versions: [
      { version: "4.0.0", date: "2024-01-22", changelog: "Added SolidJS starter, updated all deps" },
  ...
  },
  {
    ...
    description: "Comprehensive security auditing tools: SAST rules, dependency scanning configs, secret detection patterns, and compliance checklists.",
    author: "seceng",
...
export function getCategories(): string[] {
  return ["All", "Skills", "Personas", "Templates", "Prompt Packs", "Instruction Files", "Workflows", "MCP Servers", "Collections", "Bundles"];
}

export function getAssetKinds(): string[] {
  return ["Skill", "Persona", "Template", "Prompt Pack", "Instruction File", "Workflow", "MCP Server", "Collection", "Bundle"];
}
...
export const featuredAssets = [
  {
    ...
    description: "AI-powered code review for PRs. Detects bugs, security issues, and style violations with inline comments.",
    category: "skills",
    downloads: 15420,
    rating: 4.8,
    reviewCount: 127,
  ...
  },
  {
    ...
    description: "15+ years experience. Architectural guidance, mentoring, pragmatic solutions. Your virtual staff engineer.",
    category: "personas",
    downloads: 8930,
    rating: 4.9,
    reviewCount: 89,
  ...
  },
  {
    ...
    description: "Production-ready React components with TypeScript, Storybook, testing, and accessibility built-in.",
    category: "templates",
    downloads: 22100,
    rating: 4.7,
    reviewCount: 203,
