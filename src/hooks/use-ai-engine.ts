...
import type { GenerationContext, GenerationOptions, GenerationResult, GenerationOutputKind } from "@/services/providers/types";
 ...
 * Synchronous — calls pure renderBlueprint directly.
 */
 ...
 * Flow: local blueprint → send to configured AI provider → return refined result.
 *
