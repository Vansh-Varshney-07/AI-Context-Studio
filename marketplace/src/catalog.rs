...
impl std::fmt::Display for AssetType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            AssetType::Persona => write!(f, "persona"),
            AssetType::Workflow => write!(f, "workflow"),
            AssetType::PromptPack => write!(f, "prompt_pack"),
            AssetType::Memory => write!(f, "memory"),
            AssetType::InstructionFile => write!(f, "instruction_file"),
            AssetType::SystemPrompt => write!(f, "system_prompt"),
            AssetType::ModuleConfig => write!(f, "module_config"),
        }
    }
}
