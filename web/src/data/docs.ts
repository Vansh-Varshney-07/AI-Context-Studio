...
export const docSearchIndex = [
  {
    title: 'Introduction',
    url: '/docs',
    content: 'AI Context Studio is a local-first prompt engineering studio...',
  },
  {
    title: 'Quick Start',
  ...
  },
  {
    ...
    content: 'Download and install AI Context Studio on Windows, macOS, or Linux...',
  },
  {
    title: 'Instruction Files',
    url: '/docs/desktop/instruction-files',
    content: 'Create AGENTS.md and per-target agent instructions...',
  },
  {
    title: 'Prompt Library',
    url: '/docs/desktop/prompt-library',
    content: 'Browse, search, and use curated prompt templates...',
  },
  {
    title: 'MCP Manager',
    url: '/docs/desktop/mcp',
    content: 'Configure Model Context Protocol servers...',
  },
  {
    title: 'Marketplace',
    url: '/docs/marketplace/browsing',
    content: 'Discover and install community assets...',
  },
  {
    title: 'Asset Schema',
    url: '/docs/registry/schema',
    content: 'Understand the .acs asset package format...',
  },
  {
    title: 'Security',
    url: '/docs/security',
    content: 'Local-first philosophy, encryption, API key management...',
  },
];
