...
export const downloadPlatforms = [
  ...
  },
  {
    os: "macOS",
    variants: [
      { label: "Universal (Apple Silicon + Intel)", arch: "universal", size: "52 MB", ext: ".dmg", checksum: "sha256:..." },
      { label: "Apple Silicon (ARM64)", arch: "arm64", size: "48 MB", ext: ".dmg", checksum: "sha256:..." },
    ],
  ...
  },
  {
    ...
    variants: [
      ...
      { label: "RPM (Fedora/RHEL)", arch: "x64", size: "44 MB", ext: ".rpm", checksum: "sha256:..." },
...
export const roadmapPhases = [
  {
    ...
    status: "completed",
    items: [
      { title: "Desktop App v1.0", description: "Core workspace with system prompts, instruction files, memories, MCP, workflows", quarter: "Q1 2024" },
      { title: "Marketplace Frontend", description: "Browse, search, filter assets with categories and compatibility badges", quarter: "Q2 2024" },
      { title: "Registry Specification", description: "Manifest schema, versioning, dependencies, compatibility matrix", quarter: "Q2 2024" },
      { title: "Documentation Site", description: "Full docs with Getting Started, Installation, Developer Guide, Architecture", quarter: "Q2 2024" },
    ],
  },
  {
    phase: "In Progress",
    status: "in-progress",
    items: [
      { title: "Online Hub (Sync)", description: "Cross-device sync, team workspaces, shared collections, version history", quarter: "Q3 2024" },
      { title: "Plugin SDK", description: "TypeScript SDK for building custom exporters, validators, and integrations", quarter: "Q3 2024" },
      { title: "AI Agent Orchestration", description: "Multi-agent workflows with routing, memory sharing, and tool use", quarter: "Q4 2024" },
      { title: "Extension System", description: "VS Code extension, Raycast extension, CLI tool", quarter: "Q4 2024" },
    ],
  },
  {
    phase: "Planned",
    status: "planned",
    items: [
      { title: "Teams & Enterprise", description: "RBAC, SSO/SAML, audit logs, compliance, private marketplace", quarter: "Q1 2025" },
      { title: "Cloud Marketplace Hosting", description: "Managed registry hosting with CDN, analytics, monetization", quarter: "Q1 2025" },
      { title: "Mobile Companion", description: "iOS/Android app for viewing and managing assets on the go", quarter: "Q2 2025" },
      { title: "AI-Powered Asset Generation", description: "Generate prompts, skills, workflows from natural language", quarter: "Q2 2025" },
    ],
  },
  {
    phase: "Future",
    status: "future",
    items: [
      { title: "Federated Registry", description: "Decentralized asset discovery across multiple registries" },
      { title: "Prompt Optimization Engine", description: "Automatic prompt improvement via evaluation and iteration" },
      { title: "Visual Workflow Builder", description: "Drag-and-drop workflow construction with real-time preview" },
      { title: "Marketplace Monetization", description: "Paid assets, subscriptions, revenue sharing for creators" },
    ],
  },
];
