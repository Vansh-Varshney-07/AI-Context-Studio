...
import type { GeneratorQuestion } from "./types/generator";
...
export const GENERATOR_QUESTIONS: readonly GeneratorQuestion[] = [
  ...
  },
  {
    ...
    label: "Tech stack",
    kind: "textarea",
    placeholder: "TypeScript, Next.js 16, Tailwind v4, Zustand…",
    appliesTo: [
      "claude",
      "cursor",
      "copilot",
  ...
  },
  {
    ...
    kind: "textarea",
    placeholder: "src/app — routes, src/features — module slices…",
    appliesTo: ["claude", "codex", "general"],
  },
  {
    id: "style",
    label: "Code style",
    kind: "textarea",
    placeholder: "PascalCase components, snake_case tests…",
    appliesTo: [
      "claude",
      "cursor",
      "copilot",
  ...
  },
  {
    ...
    kind: "textarea",
    placeholder: ".next/, node_modules/, build artifacts…",
    appliesTo: ["claude", "cursor", "copilot", "codex", "general"],
  },
  {
    id: "modes",
